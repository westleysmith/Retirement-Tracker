...
A Monte Carlo retirement projection tool that models your actual career progression, glide-path asset allocation, and tax-aware withdrawals. Built in Python with a Streamlit UI.

Most retirement calculators assume a flat salary, a flat return, and no career progression. This one doesn't.

## What it models

- **Career stages.** One row per phase of your career: age, title, salary, contribution percentage, employer match. Add as many rows as you need to map out raises, promotions, and job changes.
...
2. Edit the **Career stages** table - one row per role/phase, with the age it began, salary, your contribution %, and employer match %.
3. Click **Run simulation**.
4. Save the scenario with a name. Try variations ("base", "if I get promoted", "aggressive FIRE") and compare.
